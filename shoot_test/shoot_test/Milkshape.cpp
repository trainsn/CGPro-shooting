...
#define HUGE_MODEL 1e10;

Milkshape::Milkshape()
{
    bbox.xmax = -HUGE_MODEL;
    bbox.ymax = -HUGE_MODEL;
    bbox.zmax = -HUGE_MODEL;
    bbox.xmin = HUGE_MODEL;
    bbox.ymin = HUGE_MODEL;
    bbox.zmin = HUGE_MODEL;
}
...
bool Milkshape::loadModelData(const char *filename)
{
...
void Milkshape::updateTransfMatrix()
{
    GLfloat mv[16];
...
void Milkshape::drawBoundingBox()
{
